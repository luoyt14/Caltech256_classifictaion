...
def save_processed_data(X_train, X_test, y_train, y_test, algo_type="_svm"):
    XtrainName = "../data/Xtrain"+algo_type+".mat"
    XtestName = "../data/Xtest"+algo_type+".mat"
    YtrainName = "../data/Ytrain"+algo_type+".mat"
    YtestName = "../data/Ytest"+algo_type+".mat"
...
if __name__ == '__main__':
    ...
    # XtrainName = "../data/Xtrain_svm.mat"
    # XtestName = "../data/Xtest_svm.mat"
    # YtrainName = "../data/Ytrain_svm.mat"
    # YtestName = "../data/Ytest_svm.mat"
    ...
    svm_classify(Xtrain, Xtest, y_train, y_test)
